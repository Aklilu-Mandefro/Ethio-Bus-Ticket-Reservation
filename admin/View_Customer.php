...
if(isset($_GET['rs_id']))
	...
	if($opr=="del")
{
	$del_sql=mysql_query("DELETE FROM manageracc WHERE manager_id=$id");
	if($del_sql)
...
<table width="755">
	<tr>
    	<td width="190px" style="font-size:18px; color:#006; text-indent:30px;">View Managers</td>
        <td>
...
<form method="post">
	...
	if($key !="")
		$sql_sel=mysql_query("SElECT * FROM manageracc WHERE fname  like '%$key%' or lname like '%$key%'");
	else
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td><a href="?tag=customer_entry&opr=upd&rs_id=<?php echo $row['manager_id'];?>" title="Update"><img src="picture/update.png" /></a></td>
            <td><a href="?tag=view_customer&opr=del&rs_id=<?php echo $row['manager_id'];?>" title="Delete"><img src="picture/delete.png" /></a></td>
