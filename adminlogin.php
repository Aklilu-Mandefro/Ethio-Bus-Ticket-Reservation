...
<div id="adlog">
<div id="welcome">
<h4 align="center" style="padding-top:5px;">ADMIN LOGIN FORM</h4>	
</div>


<form action="loginadmin.php" method="post" name="login_form" class="contact_form" onSubmit="return (go());">
	    <table id="ttp" align="center" border="0"cellpadding = "5" cellspacing = "10">
	    
             <tr><td colspan="2">  <img height="45" width="67px" src="image/LoginRed.jpg"/>  </td>   </tr>    
			...
			<td align="left"><button id="button12"  type="submit" name="login"><b>LogIn</b></button>&nbsp;&nbsp;&nbsp;
                ...
                <td><center><a class="btn btn-success" href="forgettadmin.php"><font color="white">Forget Your Password?</font></a></td></center></tr>             
