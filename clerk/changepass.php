...
if (isset($_POST['change_password'])) 
	...
	$resulsasst = mysql_query("SELECT * FROM clerkacc WHERE username = '$username'  and   password='$priv_password' ");
	...
	echo '<div class="alert alert-dismissable alert-error"><strong>';
		...
		$chack = mysql_query("UPDATE clerkacc SET password='$new_password' WHERE username = '$username'    ");
