...
<?php } ?></td></tr>
			...
			<tr>
	        <td align=right style="color:white"><label>Message:</label></td>
            <td align=left><textarea class="span3" rows="3" name="message" style='width:200px; height: 60px; border-radius: 5px; color: blue; font-size: 15px; border-color:#1ee1dc;' pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{5,150}$" title="Please enter a your message." ></textarea></td></tr>
