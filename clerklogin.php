...
<div id="center">
<div id="welcome">
<h4 align="center" style="padding-top:5px;">CLERK LOGIN FORM</h4>	
</div>
...
<form action="login_infoclerk.php" method="post" name="login_form" class="contact_form">
	    <table id="ttp" align="center" border="0"cellpadding = "5" cellspacing = "10">
			...
			<input type="reset" value="Cancel" id="button12"/></td>
             <td><center><a class="btn btn-success" href="forget.php"><font color="white">Forget Your Password?</font></a></td></center></tr>             
			</tr>
