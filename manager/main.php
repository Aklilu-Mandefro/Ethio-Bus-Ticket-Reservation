...
<div id="admin">
  ...
  <div>
                    	<a href="ss.php" class="customer" title="changepass">&nbsp;My Home page</a>
                    </div>
    ...
    <div id="rmain">
		...
		<td>
		<h3 align="left" style="color:white"> Manager Page</h3>
		</td>
		</tr>
		</table>
             </div><!--end of pic_manu -->
         ...
         <div id="menu2">
                ...
                <!--li id="li_menu"><a href="#">Create</a>
                    ...
                    <ul>
						...
						<li id="li_submenu">
                        <a href="main.php?tag=managercc" class="sales">Manager</a></li>
						<li id="li_submenu">
                        <a href="main.php?tag=reg" class="sales">Clerk</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="#">Reservation</a>
                    ...
                    <ul>
                        <li id="li_submenu">
                        <li><a href="../download.php"><i class="icon-download-alt icon-large"></i>download</a></li>
